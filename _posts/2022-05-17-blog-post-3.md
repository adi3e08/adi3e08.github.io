...
tags:
  ...
  - Maximum Entropy RL
---
Soft Actor-Critic (SAC) is a state-of-the-art deep RL algorithm for continuous action spaces. It is model-free, adopts an off-policy actor-critic approach and uses stochastic policies. One of the key ideas behind the success of SAC is that it uses the maximum entropy formulation to encourage stability and exploration.
