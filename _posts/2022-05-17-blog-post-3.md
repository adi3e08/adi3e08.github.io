...
tags:
  ...
  - Maximum Entropy RL
---
Soft Actor-Critic (SAC) is a state-of-the-art model-free deep RL algorithm for continuous action spaces. It adopts an off-policy actor-critic approach and uses stochastic policies. One of the key ideas in SAC is the use of the maximum entropy formulation to encourage stability and exploration.
