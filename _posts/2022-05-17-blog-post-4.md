...
You can find my Pytorch implementation of DDPG [here](https://github.com/adi3e08/DDPG-Pytorch){:target="_blank"}. I have tried to keep the code simple and minimal.
