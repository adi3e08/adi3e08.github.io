...
\\]
\\[
\boldsymbol{k3} = f((\boldsymbol{q}_{t}, \dot{\boldsymbol{q}}_{t}) + \frac{\Delta_{t}}{2} \, k2, \boldsymbol{\tau})
\\]
\\[
\boldsymbol{k4} = f((\boldsymbol{q}_{t}, \dot{\boldsymbol{q}}_{t}) + \Delta_{t}} \, k3, \boldsymbol{\tau})
\\]
\\[
