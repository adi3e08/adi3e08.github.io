...
\boldsymbol{k2} = f((\boldsymbol{q}_{t}, \dot{\boldsymbol{q}}_{t}), \boldsymbol{\tau}) + \Delta_{t} \, k1\\
...
### RK4
$$\boldsymbol{k1} = f(\boldsymbol{q}_{t}, \dot{\boldsymbol{q}}_{t}, \boldsymbol{\tau})\\
\boldsymbol{k2} = f((\boldsymbol{q}_{t}, \dot{\boldsymbol{q}}_{t}), \boldsymbol{\tau}) + \frac{\Delta_{t}}{2} \, k1\\
\boldsymbol{k3} = f((\boldsymbol{q}_{t}, \dot{\boldsymbol{q}}_{t}), \boldsymbol{\tau}) + \frac{\Delta_{t}}{2} \, k2\\\boldsymbol{k4} = f((\boldsymbol{q}_{t}, \dot{\boldsymbol{q}}_{t}), \boldsymbol{\tau}) + \Delta_{t} \, k3\\
